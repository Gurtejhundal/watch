  ...
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-accent selection:text-white">
      ...
      <section className="relative w-full">
        ...
        <div className="absolute top-0 left-0 w-full h-screen flex flex-col md:flex-row items-center md:items-center justify-center md:justify-between px-6 md:px-24 pointer-events-none z-10 text-center md:text-left gap-12 md:gap-0">
          <div className="max-w-md mt-[-40%] md:mt-[-10%]">
            ...
            <button className="md:hidden pointer-events-auto bg-transparent border border-metal text-foreground hover:bg-foreground hover:text-white transition-all px-8 py-3 text-xs tracking-widest uppercase mt-4">
              Discover
            </button>
          </div>
      ...
      <section className="py-20 md:py-32 px-6 bg-background relative z-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-metal/20 p-8 md:p-10 group hover:border-accent/30 transition-colors">
              <div className="w-16 h-16 rounded-full border border-metal/30 flex items-center justify-center mb-6 group-hover:border-accent/50 transition-colors">
      ...
      {/* ─── NEWSLETTER BANNER ─── */}
      <section className="py-20 md:py-28 px-6 bg-background-secondary border-t border-metal/20 relative z-20">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-xs tracking-[0.3em] uppercase mb-4 text-accent">Stay Informed</p>
          <h2 className="text-3xl md:text-4xl font-serif mb-6">Keep in Touch</h2>
